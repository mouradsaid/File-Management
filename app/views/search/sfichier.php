...
<div id="addEmployeeModal" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo URLROOT;  ?>files/registerFile" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">					
          <div class="form-group">
            <label>Titre</label>
            <input type="text" class="form-control" name="dtitre" required>
          </div>
          <div class="form-group">
            <label>Type</label>
          ...
          <div class="form-group">
            ...
            <input type="file" name="ddocument" id="" class="form-control" accept=".xlsx,.xls,image/*,.doc,.docx,.ppt,.pptx,.txt,.pdf,.zip,.rar,.jpeg,.bmp,.webp" required>
          </div>					
        </div>
